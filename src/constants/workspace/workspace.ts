...
export const WORKSPACE_TAB_LIST_HORIZONTAL_PADDING_REM = 0.375;
export const WORKSPACE_TAB_LIST_TOP_PADDING_REM = 0.375;
export const WORKSPACE_TAB_LIST_BOTTOM_PADDING_REM = 0.5;
export const WORKSPACE_TAB_LIST_VISIBLE_COUNT = 6;
