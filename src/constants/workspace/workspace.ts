...
const WORKSPACE_TAB_LIST_ITEM_HEIGHT_REM = 2;
const WORKSPACE_TAB_LIST_HORIZONTAL_PADDING_REM = WORKSPACE_MENU_INSET_REM;
const WORKSPACE_TAB_LIST_TOP_PADDING_REM = WORKSPACE_MENU_INSET_REM;
const WORKSPACE_TAB_LIST_BOTTOM_PADDING_REM = WORKSPACE_MENU_INSET_REM;
const WORKSPACE_TAB_LIST_VISIBLE_COUNT = 5;
