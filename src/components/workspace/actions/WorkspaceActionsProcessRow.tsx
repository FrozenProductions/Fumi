...
type WorkspaceActionsProcessRowProps = {
    index: number;
...
export function WorkspaceActionsProcessRow({
    ...
    options,
    process,
}: WorkspaceActionsProcessRowProps): ReactElement {
    ...
    const maskedProcessAccountLabel = getRobloxProcessAccountLabel(process, {
        isMasked: true,
    });
                ...
                {isKillingProcess ? (
                    ...
                    <>
                        ...
                        <div
                            ...
                            onFocus={() => actions.onRevealProcess(process.pid)}
                            onBlur={(event) =>
